...
# Description: This package, in partial fulfillment of the requirements of the #
# Coursera course, "Data Science Capstone", contains functions for an          #
# auto-completion model that predicts the next word to be typed based on a     #
# word or phrase previously typed.                                             #
