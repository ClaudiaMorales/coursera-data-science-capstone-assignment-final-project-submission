################################################################################
# This package, in partial fulfillment of the requirements of the Coursera     #
# course, "Data Science Capstone", contains a predictive model to predict the  #
# next word to be typed for an auto-completion function for mobile devices.    #
################################################################################
